...
function create(n) {
	...
	element_2.setAttribute('onclick', "location.href = '../html/percentage.html';");
...
function getInput(i) {
	...
	var message = document.getElementById('the-message');
	if (selecting > 100 || selecting < 0) {
		var danger = '<div class="alert alert-danger" role="alert"><strong>Error</strong> Your Marks Should not be Greater Than 10 or Less Than 0.</div>';
		message.innerHTML = danger;
...
function cal() {
	...
	if (checker(a)) {
		...
		var success = '<div class="alert alert-success" role="alert">Your Average percentage is <strong>' + average.toFixed(2) + '%</strong></div>';
